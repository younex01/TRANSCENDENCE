    ...
    return (
        <div className='h-screen flex flex-col justify-center items-center w-screen bg-center bg-[#dbe0f6] z-[1001] absolute'>
            <div>
                ...
                <div className='flex items-center justify-center w-[150px] h-[150px] bg-[#D2E5F5] rounded-full shadow-notmember bg-cover' style={{backgroundImage: `url(/giphyluu.gif)`}}>
            ...
            <div className='flex  items-center justify-center gap-[26px]'>
                ...
                <div className='flex flex-col items-center justify-center gap-[26px]'>
                    <Link href='/Chat' className='text-[#FFF] text-[20px] max-w-[481px] font-[Poppins] font-[600] text-center bg-[#252f5b] py-[19px] px-[94px] rounded-[11px] shadow-notmember1' >
                        Go back To Chat
                    </Link>
                </div>
        </div>
