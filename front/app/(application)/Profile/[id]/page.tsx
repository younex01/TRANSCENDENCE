...
import { setFreindInfo, setFreindRequestInfo } from '@/redux/features/freinds/requestSlice';
...
export default function Profile(props: any) {
    ...
    useEffect(() => {
      const getUserData = async () => {
        try {
          const response = await axios.get(`http://localhost:4000/user/getUserByUserId?user=${props.params.id}`);
                            ...
                            <div className='relative mt-2 w-full flex gap-3 items-start'>
                                <div className='flex flex-row items-center gap-6 ml-2'>
                                    ...
                                    <div className='flex flex-col justify-center items-center gap-1 w-max-content'>
                                        <div>{userData?.firstName} {userData?.lastName} as</div>
