                        ...
                        : <div className='mt-7 border-black flex'>
                          ...
                          <div className='rounded-tr-[24px] rounded-b-[24px]  '>
                            <div className='flex h-[45px]'>
                              ...
                              {(groupData?.owner == missage.userId) && <div className='ml-2 mt-1 rounded-[9px] font-light text-white  h-fit px-2 py-[2px] bg-[#d33939]' >owner</div>}
                              {(checkIfAdmin(missage.userId)) && <div className='ml-2 mt-1 rounded-[9px] font-light text-white  h-fit px-2 py-[2px] bg-[#7239D3]' >admin</div>}
                            </div>
