...
const TeamCard = ({
  ...
  return (
    <div className="w-[80%] lg:w-[98%] flex flex-col justify-evenly items-center h-[100%] rounded-[30px] bg-[#f5f7ff] relative overflow-hidden pt-11 pb-11">
