          ...
          <div key={index} className='flex flex-row items-center justify-center w-full lg:w-10/12 2xl:w:10/12 '>
            <div className='w-[50%] h-[150px] flex flex-row items-center justify-around'>
              <div className='flex flex-col items-center justify-center'>
                <p className={game.result ? `text-green-300` : `text-red-300`}>{profilepic.username}</p>
                <h4 className={game.result ? `text-green-300` : `text-red-300`}>{game.score.player}</h4>
              </div>
            ...
            <div className='w-[50%] h-[150px] flex flex-row items-center justify-around'>
              ...
              <div className='flex flex-col items-center justify-center'>
                <p className={!game.result ? `text-green-300` : `text-red-300`}>name</p>
                <h4 className={!game.result ? `text-green-300` : `text-red-300`}>{game.score.opponent}</h4>
              </div>
            </div>
